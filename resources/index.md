...
Welcome to the Lemma Overloading project website! This project is part of [coq-community](https://github.com/coq-community/manifesto).
...
The current stable release of Lemma Overloading can be [downloaded from GitHub](https://github.com/coq-community/lemma-overloading/releases).
